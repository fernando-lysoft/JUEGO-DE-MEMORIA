...
function destapar(id){
    ...
    if(tarjetasDestapadas == 1){
        ...
        tarjeta2.innerHTML = segundoResulado;
        ...
        if(primerResultado == segundoResulado){
            ...
            if(aciertos == 8){
                ...
                mostrarTiempo.innerHTML = `Fantastico! &#129303 Solo demoraste: ${timerInicial-timer} segundos`;
                mostrarMovimientos.innerHTML = `Movimientos: ${movimientos} &#128170 &#128526`;
            }
